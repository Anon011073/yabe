    ...
    return new Promise((resolve, reject) => {
      chrome.bookmarks.getSubTree('1', (results) => {
        ...
        if (appFolder) {
          ...
          // If the folder doesn't exist, the manager has nothing to manage.
          reject("Dashboard Bookmarks folder not found. Please add bookmarks via the options page first.");
        }
      });
    });
  }
